...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:ctailliez@cta.li}{{\footnotesize\faEnvelope}\hspace*{0.13cm}ctailliez@cta.li}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}\hrefWithoutArrow{https://osm.org/go/b~vJaW6?relation=2195069}{Artiguelouve (64)}}%
        \kern 0.25 cm%
        \AND%
        %\kern 0.25 cm
    ...
    \section{Expériences Professionn}
        ...
        \begin{threecolentry}{\textbf{BTS}}{
            ...
            \textbf{Lycée St John Perse}, Service Informatique aux Organisations \\
            Option Réseau Infrastructure et Système Communiquant
            \begin{highlights}
    ...
    \section{Compétences Acquises}
        ...
        \begin{onecolentry}
            \textbf{Software:} Docker, DSM, Git, GrapheneOS, G Workspace, IDA Pro, Inkscape, Office 365, VScode
        \end{onecolentry}
    ...
    \section{Centre d'Intérêt}
        ...
        \begin{onecolentry}
            Gaming, informatique (programmation \& réseau), musique.
        \end{onecolentry}
