...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\begin{minipage}{\textwidth}
        ...
        \textit{\small CT - p.\thepage{} sur \pageref*{LastPage}}\\
        \textit{\small{maj : le }}%
...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{ver: 1.3}\hspace{\widthof{ver: 1.3}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \section{Diplômes, Formations}
        ...
        \begin{threecolentry}{\textbf{BAC Pro}}{
            ...
            \textbf{SEN} Option Solutions d'Infrastructures Systèmes et Réseaux
            \begin{highlights}
