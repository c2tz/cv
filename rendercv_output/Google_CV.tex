...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Google - Page \thepage{} sur \pageref*{LastPage}}
...
\AddToShipoutPictureFG*{% Add <stuff> to current page foreground
  \put(
      \LenToUnit{\paperwidth-2 cm-0.2 cm-0.85cm}, %-0.85 for approvatively same value than April 2024 with my settings (\date\today bug color work but not textit and margin aren't the same )
      ...
      % \textit{Last updated in April 2024}\hspace{\widthof{Last updated in April 2024}}
  }}}%
}%
}%
% end
...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{
            {\footnotesize\faMapMarker*}\hspace*{0.13cm}Artiguelouve
        }
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{mailto:c2tz@pm.me}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}c2tz@pm.me}
        }
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{tel:+33-6-43-83-04-03}{{\footnotesize\faPhone*}\hspace*{0.13cm}+33 6 43 83 04 03}
        }
        \kern 0.5 cm
        \mbox{
