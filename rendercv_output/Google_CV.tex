...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Google - Page \thepage{} of \pageref*{LastPage}}
...
\AddToShipoutPictureFG*{% Add <stuff> to current page foreground
  \put(
      \LenToUnit{\paperwidth-2 cm-0.2 cm-0.85cm}, %-0.85 for approvatively same value than May 2024 with my settings (\date\today bug color work but not textit and margin aren't the same )
      ...
      % \textit{Last updated in May 2024}\hspace{\widthof{Last updated in May 2024}}
  }}}%
}%
}%
% end
...
\begin{document}
    ...
    \begin{header}
        ...
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{mailto:youremail@domain.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}youremail@domain.com}
        }
        \kern 0.5 cm
        \mbox{
    ...
    \section{Publications}
        ...
        \begin{twocolentry}{
            ...
            \begin{minipage}{\linewidth}
                ...
                \mbox{Albert Smith}, \mbox{Google}, \mbox{Jane Derry}, \mbox{Harry Tom}, \mbox{Frodo Baggins}
                \vspace{0.10 cm}
